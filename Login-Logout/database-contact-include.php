                        ...
                        <h1>Daten der Datenbank</h1>
                            <table class="database_content">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT id, Vorname, Nachname, EMail, Betreff, Nachricht, Datum FROM contact ORDER BY Datum DESC";
                                        foreach ($pdo->query($sql) as $row) {  
                                            echo "<tr>"."<td>".$row['id']."</td>"."<td>".$row['Vorname']." ".$row['Nachname']."</td>"."<td>".$row['EMail']."</td>"."<td>".$row['Betreff']."</td>"."<td>".$row['Nachricht']."</td>"."<td>".$row['Datum']."</td>"."</tr>";
                                            $i++;
                                        }
                                ?> 
                            </table>
